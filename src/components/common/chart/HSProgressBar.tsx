...
export function HSProgressBar({text, value, textTransform, theme}: {text: string, value: number, textTransform?: string, theme?: string}) {
  ...
  return (
    <div style={{width: '100%', height: '100%', background: `rgba(${colorset[6]},${colorset[7]},${colorset[8]},0.3)`, position: 'relative'}}>
      ...
      backgroundImage: `linear-gradient(to right, rgba(${colorset[6]},${colorset[7]},${colorset[8]},0.2), rgb(${colorset[6]},${colorset[7]},${colorset[8]}))`}}/>
    </div>
  );
}
